...
public  class EmployeeMySQLDAOImpl implements IEmployeeDAO {
	private static   final  String  GET_EMPS_BY_DESGS="SELECT EMPNO,ENAME,JOB,SALARY,DEPTNO  FROM EMP WHERE JOB IN(?,?,?)";
	private static   final  String  INSERT_EMPLOYEE="INSERT INTO EMP(ENAME,SALARY,JOB,DEPTNO) VALUES(?,?,?,?)";
